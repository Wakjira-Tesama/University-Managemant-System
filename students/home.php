...
else
{
	...
	$st_name = $jxnu->student_info_select($st_username);
									...
									<div class="content tab">
											...
											<div class="col-md-12">
												...
												if(isset($_POST['change_password']))
												{
													...
													$st_password_update = $_POST['new_password'];
														$update_success = $jxnu->student_password_change($st_password_update,$st_username);
										...
										<section id="section-3">
												<div class="graph">
															...
															$sn = 1;
															$teacher_info_in_student = $jxnu->teacher_info_instudent($st_grade);
